...
def test_one(filedir, qlevel=12, Qstep=2**20, DBG=False):
    ...
    psnr_results = pc_error(outfile1, outfile2, resolution=1)
...
def test_all(filedir, qlevelList=[12,11,10,9]):
    ...
    for i, qlevel in enumerate(qlevelList): 
        ...
        print('DBG!!! bpp, psnr:\t', results['bpp'], results['mseF,PSNR (p2point)'])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prefix",type=str, default='gpcc_attn')
